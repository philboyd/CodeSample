...
fun <A : Any> A?.toSome(): Option.Some<A>? = if (this == null) null else Option.Some(
    this
)
...
fun <A : Any> List<A>.toOption(): Option<List<A>> = if (isNotEmpty()) Option.Some(
    this
) else Option.None

fun <A : Any> Set<A>.toOption(): Option<Set<A>> = if (isNotEmpty()) Option.Some(
    this
) else Option.None
